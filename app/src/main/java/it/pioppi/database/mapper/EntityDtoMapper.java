...
import it.pioppi.business.dto.item.ItemFTSDto;
...
import it.pioppi.business.dto.item.ItemWithProviderDto;
...
public class EntityDtoMapper {
    ...
    public static QuantityTypeDto entityToDto(QuantityTypeEntity quantityTypeEntity) {
        ...
        quantityItemDto.setQuantityType(quantityTypeEntity.getQuantityTypeEnum());
    ...
    public static QuantityTypeEntity dtoToEntity(QuantityTypeDto quantityItemDto) {
        ...
        quantityTypeEntity.setQuantityTypeEnum(quantityItemDto.getQuantityType());
